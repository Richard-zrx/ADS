...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare math-ai/aime25 into unified VeRL/GRPO format.")
...
def main() -> None:
    ...
    print(f"[aime25] input_rows={input_rows} output_rows={output_rows}")
    print(f"[aime25] parquet={parquet_path}")
    print(f"[aime25] example={example_path}")
