...
class SamplingConfig(BaseConfig):
    ...
    do_sample: bool = True
    n: int = 1
    n_per_data_source: dict[str, int] = field(default_factory=dict)
...
class RolloutConfig(BaseConfig):
    ...
    # Validation-only response length override. Falls back to response_length when None.
    val_response_length: Optional[int] = None
